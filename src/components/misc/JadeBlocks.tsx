        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="text-lg text-gray-700 leading-relaxed space-y-4">
              ...
              <p>
                By removing the &quot;complexity barrier&quot; that has
                historically limited options adoption, Jade empowers advisors to
                confidently implement yield-generating strategies, manage
                concentrated stock positions, and create customized income
                solutions—all while maintaining full compliance and oversight.
              </p>
            </div>
          </div>
        </div>
